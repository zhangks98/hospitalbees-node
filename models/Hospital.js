...
module.exports.incQueueNumberGenerator = function(hospitalID, callback){
    try{
    database.query("UPDATE Hospital SET Hospital_QueueTail = Hospital_QueueTail + 1 WHERE Hospital_HospitalID = '"+hospitalID+"'", function(err, result){
...
module.exports.closeHospital = function(hospitalID, callback){
    try{
    database.query("UPDATE Hospital SET Hospital_QueueTail = 0 WHERE Hospital_HospitalID = "+hospitalID+" ", function(err, result){
